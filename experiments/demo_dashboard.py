#!/usr/bin/env python3
"""
demo_dashboard.py -- PRESENTATION ONLY.  Support file for demo_bench_ab19.py.

This file contains NO physics, NO controller and NO simulation.  It draws numbers and
curves that demo_bench_ab19.py hands it after each MuJoCo step.  Nothing here can change
...
DELIBERATELY NOT SHOWN
    ...
    known-defective (see bench_track_ab19.audit_reference §R4) and must not appear in a
...
class Dashboard:
    ...
    demo_bench_ab19.py passes in exactly what it read out of data.sensordata."""
...
class WebDashboard:
    ...
    demo_bench_ab19.py just read out of data.sensordata on the current step; the numbers
...
def make_dashboard(title, subtitle, meta, static, limits, geometry=None, force=None,
    ...
    return TerminalDashboard(
        meta, why=("Asked for with --dashboard terminal." if force == "terminal"
                        ...
                        "experiments/demo_dashboard.py to test the window alone."))


# ===================================================================== manual self-test
def _selftest(port=8787, seconds=90.0, open_browser=True, force="auto"):
    """`python experiments/demo_dashboard.py` -- opens the dashboard on a synthetic
...
if __name__ == "__main__":
    ...
    p = argparse.ArgumentParser(description="Open the demo dashboard on synthetic data "
